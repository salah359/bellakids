...
// Translation Dictionary (Expanded for Hero & Categories)
const translations = {
    "en": {
        "nav-home": "Home",
        "nav-boys": "Boys",
        ...
        "bag-btn": "Bag",
        "search-placeholder": "Search the whole collection...",
...
function openProductDetails(productId) {
    ...
    const sizeLabel = document.querySelector('label[for="sizeSelector"]');
